...
export const DISPATCHERS: readonly Dispatcher[] = [
  { name: 'Carlos', bg: 'bg-red-100', text: 'text-red-700', ring: 'ring-red-300', badge: 'bg-red-100 text-red-600' },
  ...
  { name: 'Pa', bg: 'bg-blue-100', text: 'text-blue-700', ring: 'ring-blue-300', badge: 'bg-blue-50 text-blue-600' },
] as const;
