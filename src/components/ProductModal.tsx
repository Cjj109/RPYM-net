        ...
        <div className="p-4 md:p-6">
          {product.descripcion ? (
            <>
              ...
              <p className="text-ocean-700 text-sm md:text-base leading-relaxed">
                {product.descripcion}
              </p>
            </>
          ) : (
            <p className="text-ocean-700 text-sm italic">
          ...
          <div className="mt-4 pt-4 border-t border-ocean-100">
            ...
            <div className="flex items-center gap-2 text-sm text-ocean-700 mt-2">
              <svg className="w-4 h-4 text-ocean-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
