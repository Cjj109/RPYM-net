...
export const GET: APIRoute = async ({ request, locals }) => {
  ...
  try {
    ...
    // IVA Balance = IVA débito fiscal (ventas) - IVA crédito fiscal (compras)
    // Las retenciones son pagos separados a SENIAT en nombre de proveedores — no afectan este balance
    const ivaBalance = ivaCobradoBs - ivaComprasBs;
